...
cookies = {
    ...
    # 'USAWSIAMSESSIONID': 'eydGvEAO3a9VVQYEzB4ovPMY5pLAv8hrAQTnb96lri09Imdj',
    '_common_physicalAddressText': 'b4jy4qvwynelacbabhfd',
    'sa_did': 'rWNSGpAwjbfCoDzIPYQrxayRihlEbdba',
    # 'JSESSIONID': '05ABC03AA8FCFC2D34F74F7EC687C928',
    'RT': '"z=1&dm=samsung.com&si=31a8aefe-4683-41b4-bd9e-76847d64a02f&ss=m6zcplox&sl=2&tt=251&bcn=%2F%2F17de4c10.akstat.io%2F&ld=6qd&nu=kpaxjfo&cl=lzg&hd=mb8"',
    '_ga_0JTZHYKZ5Z': 'GS1.1.1739209983.1.0.1739209999.44.0.0',
}
...
headers = {
    ...
    'Referer': 'https://account.samsung.com/accounts/v1/samsung_com_us/signInGate?response_type=code&client_id=kv5di1wr19&locale=en_US&countryCode=US&redirect_uri=https:%2F%2Fwww.samsung.com%2Faemapi%2Fv6%2Fdata-login%2FafterLogin.us.json&state=GLB9v0o4yiojw8&goBackURL=https:%2F%2Fwww.samsung.com%2Fus%2F&scope=',
    'Accept-Language': 'en-US,en;q=0.9',
}

response = requests.get(
    'https://account.samsung.com/accounts/v1/samsung_com_us/signInXhr',
    cookies=cookies,
    headers=headers,
    verify=False
)
